"""
Django settings for solitary_snowflake_132754 project.
...
ROOT_URLCONF = 'solitary_snowflake_132754.urls'
...
WSGI_APPLICATION = 'solitary_snowflake_132754.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "solitary_snowflake_132754 API",
    "DESCRIPTION": "API documentation for solitary_snowflake_132754 App",
    "VERSION": "v1",
}
